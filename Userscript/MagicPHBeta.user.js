	...
	PH = {
		...
		playerQuality: function () {
			...
			const player = new Plyr('[data-tab="quality"]', {
				...
				quality: {default: 2160, options: [2160, 1440, 1080, 720, 576, 480, 360, 240] },
				...
				previewThumbnails: { enabled: true, src: 'https://dw.phncdn.com/videos/201911/19/262795372/180P_225K_262795372.webm?ttl=1590202466&rs=1200&hash=002f3983e99c3777ac6bff5e787c0dd9' }
			  });
			},
		HomePage: function () {
		...
		$(window).scroll(function(){
			var sticky = $(s.Target),
				...
				if (scroll >= 400) {
					...
					$('.fixed').css({"position": "fixed !important;", "top": "0;", "left": "0;", "width": "95vw;"});
					$('#btnMenuList').show();
				}
				else {
