 ...
 * @link https://github.com/magicoflolis/Magic-PH/tree/master/src/Common/sass
 */
const downloadCSS = `:root{--mph-site-color: hsl(36, 100%, 50%);--mph-hover-color: hsl(36, 100%, 35%);--mph-background-color: $dark;--mph-border-color: hsl(36, 100%, 50%)}.hidden{display:none !important;z-index:-1 !important}main-userjs{width:100%;width:-moz-available;width:-webkit-fill-available;font-family:Arial,Helvetica,sans-serif;font-size:14px}@media screen and (max-height: 720px){main-userjs:not(.webext-page){height:100% !important;bottom:0rem !important;right:0rem !important;margin:0rem !important}}main-userjs.expanded{height:100% !important;bottom:0rem !important}main-userjs:not(.webext-page,.mph_mobile){height:492px}main-userjs:not(.webext-page){position:fixed}main-userjs:not(.webext-page):not(.expanded){margin-left:1rem;margin-right:1rem;right:1rem;bottom:1rem}main-userjs:not(.webext-page):not(.expanded).auto-height{height:auto}main-userjs:not(.hidden){z-index:100000000000000000 !important;display:flex !important;flex-direction:column !important}.mgp_download,.mgp_downloadInfo,.mgp_downloadInfo input{color:#ccc}.mph_progressContainer{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;height:auto;color:var(--mph-site-color, var(--text-color, rgb(255, 153, 0)));background-color:var(--mph-background-color, var(--bg-color, rgb(0, 0, 0)));border:1px solid var(--mph-border-color, var(--text-color, rgb(255, 153, 0)));margin:0 3px;border-radius:1000px;padding:14px 16px;position:fixed;display:none;top:15em;left:.5em;z-index:50000}.mph_progressContainer h1{line-height:20px;text-align:center;font-size:16px;font-family:inherit;font-weight:500;margin:auto;color:currentcolor !important}.mgp_download .magicph-icon{height:1.25em}.mgp_videoStarted.mgp_hideControls .mgp_download{display:none}.mgp_contextMenu>.mgp_content>.mgp_download{border-bottom:1px solid rgba(255,255,255,.2) !important}ul.mgp_switches>.mgp_download{display:grid !important}ul.mgp_switches>.mgp_download .magicph-icon{display:block;font-size:25px;min-height:36px;left:50%;padding-bottom:5px;position:relative;top:0px;transform:translate(-50%, 0%)}.xp-context-menu .mgp_download{color:#a1a1a1;cursor:pointer;font-family:ArialMT,sans-serif;font-size:14px;line-height:2.14;padding:0 20px}.xp-context-menu .mgp_download:hover{background:#424242;color:#fff}.mgp_controls>.mgp_download{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;height:-webkit-min-content;height:-moz-min-content;height:min-content;cursor:pointer;position:absolute;top:50%;bottom:0;left:80%;right:0;z-index:150;border-radius:5px;background-color:rgba(0,0,0,.7);padding:8px 10px}.mgp_downloadInfo,.mph_of_root{height:100%;width:100%;display:flex;flex-flow:column nowrap;border-radius:10px}.mgp_downloadInfo{background-color:rgba(0,0,0,.9);border:1px solid rgba(138,150,163,.25)}.mgp_downloadInfo .mph_list_header{order:0;display:flex;border-bottom:1px solid rgba(255,255,255,.2);border-top-left-radius:10px;border-top-right-radius:10px;padding:.5em;font-size:1em;place-content:space-between;height:fit-content;height:-moz-fit-content;height:-webkit-fit-content;width:100%;width:-moz-available;width:-webkit-fill-available;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.mgp_downloadInfo .mph_list_header .mgp_title{cursor:default !important;font-size:16px !important;line-height:30px !important;float:left !important}.mgp_downloadInfo .mph_list_header .mgp_hideMenu{cursor:pointer !important;font-size:25px !important;float:right !important}.mgp_downloadInfo .mph-list{order:1;overflow-x:hidden;padding:0px;width:100%;width:-moz-available;width:-webkit-fill-available;display:flex;flex-flow:column nowrap;gap:.5em}.mgp_downloadInfo .mph-list .mph-item{width:100%;display:flex;flex-flow:row wrap;align-items:center;border-bottom:1px solid rgba(255,255,255,.2);padding-top:.5em;padding-bottom:.5em;justify-content:space-evenly}.mgp_downloadInfo .mph-list .mph-item label>input{outline:0 none;background:rgba(0,0,0,0);border:0;-webkit-user-select:all !important;-moz-user-select:all !important;-ms-user-select:all !important;user-select:all !important}.mgp_downloadInfo .mph-list .mph-item mph-a{cursor:pointer;-webkit-text-decoration:0;text-decoration:0;color:var(--mph-site-color, var(--text-color, rgb(255, 153, 0)))}.mgp_downloadInfo .mph-list .mph-item mph-a:hover{color:var(--mph-hover-color, rgb(255, 153, 0));-webkit-text-decoration:0;text-decoration:0}.mgp_downloadInfo .mph-list .mph-item mph-a svg{fill:currentColor;width:14px;height:14px;background:rgba(0,0,0,0)}.mgp_downloadInfo>video{order:2;padding:1em}.mph_of_root{background-color:var(--overlay-color)}.mph_of_root .mph_of_header{gap:1em;justify-content:center;order:0;display:flex;border-bottom:1px solid rgba(255,255,255,.2);border-top-left-radius:10px;border-top-right-radius:10px;background-color:var(--overlay-color);padding:.5em;font-size:16px;height:fit-content;height:-moz-fit-content;height:-webkit-fit-content;width:100%;width:-moz-available;width:-webkit-fill-available;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.mph_of_root .mph_of_list{height:100%;width:100%;display:flex;flex-flow:row wrap;gap:1em;margin:auto;overflow-x:hidden;touch-action:auto;padding:.5em}.mph_of_root .mph_of_list.mph_mobile{flex-flow:row wrap;justify-content:center}.mph_of_root .mph_of_list .wrap{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;height:-webkit-fit-content;height:-moz-fit-content;height:fit-content;border:1px solid rgba(138,150,163,.25);border-radius:10px;background-color:var(--overlay-color);display:flex;padding:.5em;gap:.5em;flex-flow:column wrap;margin:auto}.mph_of_root .mph_of_list .wrap a{order:1}.mph_of_root .mph_of_list .wrap a img{cursor:pointer;max-width:25rem;max-height:15rem;display:block;margin:auto}.mph_of_root .mph_of_list .wrap .title>a,.mph_of_root .mph_of_list .wrap .title{font-size:17px;font-weight:700;color:var(--text-color);word-break:break-word;word-wrap:break-word;font-family:Arial,Helvetica,sans-serif;outline-style:none;text-decoration:none;text-align:center}.mph_of_root .mph_of_list .wrap .title>a:hover,.mph_of_root .mph_of_list .wrap .title:hover{text-decoration:underline}.mph_of_root .mph_of_list .wrap .title{order:2}.mph_of_root .mph_of_list .wrap .mph_of_btn_container{order:0;display:flex;gap:.5em;justify-content:center}.mph_of_root .mph_of_list .wrap video{order:3;width:10em;height:10em}input[value^="[Error] Not Found"]{visibility:hidden !important}.mph_ofsContainer{display:flex;margin:auto;position:fixed;background-color:var(--overlay-color);border:1px solid rgba(138,150,163,.25);border-radius:10px;color:inherit;justify-content:center;gap:1em;padding:.3em .5em;z-index:50000}.mph_ofsContainer:not(.mph_mobile){bottom:1em;right:1em}.mph_ofsContainer.mph_mobile{top:1em;left:1em}.mph_of_btn{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;height:-webkit-fit-content;height:-moz-fit-content;height:fit-content;cursor:pointer;color:var(--mph-site-color, var(--text-color, rgb(255, 153, 0)));background-color:var(--mph-background-color, var(--bg-color, rgb(0, 0, 0)));border:1px solid var(--mph-border-color, var(--text-color, rgb(255, 153, 0)));text-align:center;border-radius:10px;padding:0 .5em;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}`;
