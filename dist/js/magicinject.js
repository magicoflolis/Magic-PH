...
/* harmony import */ var _magicpopup_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./magicpopup.html */ "./magicpopup.html");
...
var brws = typeof browser == "undefined" ? chrome : browser,
    ...
    header = (0,_general__WEBPACK_IMPORTED_MODULE_0__.create)("div", null, "magic-customize"),
    loadCSS = src => {
  var c = (0,_general__WEBPACK_IMPORTED_MODULE_0__.create)("link", null, null);
  c.rel = "stylesheet";
  c.href = brws.runtime.getURL(src);

  c.onload = () => (0,_general__WEBPACK_IMPORTED_MODULE_0__.log)("Loaded ".concat(src));

  c.onerror = () => (0,_general__WEBPACK_IMPORTED_MODULE_0__.err)("CSS load error for ".concat(src));
  ...
  try {
    brws.storage.local.get(storedConfig => {
      ...
      var blurName = _general__WEBPACK_IMPORTED_MODULE_0__.config.blurimg ? "Unblur" : "Blur",
        ...
        if (x.length != y.length) {
          ...
          /categories/.test(_general__WEBPACK_IMPORTED_MODULE_0__.locate) ? $('a[data-mxptype="Category"] > img').addClass("blur") : false;
          /view_video.php/.test(_general__WEBPACK_IMPORTED_MODULE_0__.locate) ? ($("#videoElementPoster").addClass("blur"), $(".mgp_videoPoster").addClass("blur"), $("span.thumb > img.lazy").addClass("blur")) : false;
        ...
        var sidebar = "<a class=\"magic1\">Home</a><a class=\"magic2\">Catagories</a><a class=\"magic3\">Recommended</a><a class=\"magic4\">Taste Profile(WIP)</a><a class=\"magic5\">Favorites(WIP)</a><a class=\"magic6\">MagicPH Config</a><a class=\"magic7\"></a><a class=\"magic999\">Exit \u27F5</a>",
            ...
            lognav = (0,_general__WEBPACK_IMPORTED_MODULE_0__.create)("div", null, "sidenav"),
              ...
              try {
                fetch("https://".concat(url)).then(res => res.text()).then(text => {
                  ...
                  if (thumb !== "none") {
                    ...
                    (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".".concat(name, " > ").concat(selElement)).addEventListener('scroll', /*#__PURE__*/_asyncToGenerator(function* () {
                ...
                (0,_general__WEBPACK_IMPORTED_MODULE_0__.log)(error);
              }
            });
          });
        ...
        (_qs = (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magiclogo")) !== null && _qs !== void 0 ? _qs : ((0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)("#headerContainer > .logo").appendChild(logo), $('.logo > .logoWrapper > a > img').clone().appendTo(logo));
        lognav.innerHTML = sidebar;
        $(_magicpopup_html__WEBPACK_IMPORTED_MODULE_1__["default"]).prependTo(document.body);
        ...
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magic1").addEventListener('click', /*#__PURE__*/_asyncToGenerator(function* () {
        ...
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magic3").addEventListener('click', /*#__PURE__*/_asyncToGenerator(function* () {
          $(".magic-popup > div.categories").attr("style", "display: none;"); //$(".magic-popup > div.favorites").attr("style", "display: none;");
        ...
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magic4").addEventListener('click', /*#__PURE__*/_asyncToGenerator(function* () {
          $(".magic-popup > div.categories").attr("style", "display: none;"); //$(".magic-popup > div.favorites").attr("style", "display: none;");
        ...
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magic5").addEventListener('click', /*#__PURE__*/_asyncToGenerator(function* () {
          $(".magic-popup > div.categories").attr("style", "display: none;");
          $(".magic-popup > div.home").attr("style", "display: none;");
          $(".magic-popup > div.brws_cfg").attr("style", "display: none;");
          $(".magic-popup > div.taste").attr("style", "display: none;");
        ...
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magic6").addEventListener('click', /*#__PURE__*/_asyncToGenerator(function* () {
          $(".magic-popup > div.categories").attr("style", "display: none;");
          $(".magic-popup > div.home").attr("style", "display: none;");
        ...
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.qs)(".magic999").addEventListener('click', /*#__PURE__*/_asyncToGenerator(function* () {
          $(".magic-popup > div.categories").attr("style", "display: none;");
          $(".magic-popup > div.home").attr("style", "display: none;");
          $(".magic-popup > div.brws_cfg").attr("style", "display: none;");
          $(".magic-popup > div.taste").attr("style", "display: none;"); //$(".magic-popup > div.favorites").attr("style", "display: none;");
        ...
        for (var prop in _general__WEBPACK_IMPORTED_MODULE_0__.config) {
          prop in ff.elements ? ff.elements[prop].type == "checkbox" ? ff.elements[prop].checked = _general__WEBPACK_IMPORTED_MODULE_0__.config[prop] : ff.elements[prop].value = _general__WEBPACK_IMPORTED_MODULE_0__.config[prop] : false;
        }
        ...
        ff.addEventListener("change", e => {
          ...
          e.target;
          $el.type == "checkbox" ? _general__WEBPACK_IMPORTED_MODULE_0__.config[$el.name] = $el.checked : _general__WEBPACK_IMPORTED_MODULE_0__.config[$el.name] = $el.value;
          brws.storage.local.set(_general__WEBPACK_IMPORTED_MODULE_0__.config);
        ...
        var mod = {
          ...
          GPremium: $('.premium > a[href="/gay/premium"]')
            ...
            fg = !_general__WEBPACK_IMPORTED_MODULE_0__.check.gay ? '/recommended' : '/gay/recommended',
            selA = "<a href=\"".concat(fg, "\" class=\"active js-topMenuLink\"><span class=\"itemName\"><span class=\"arrowMenu\">Recommended</span><span class=\"activeLine\"></span></span></a>"),
            selB = "<a href=\"".concat(fg, "\" class=\"js-topMenuLink\"><span class=\"itemName\">recommended</span></a>"),
        ...
        src.Video.attr("href", mod.Video), src.Category.attr("href", mod.Category), src.Pornstar.attr("href", mod.Pornstar), src.Community.attr("href", mod.Community), src.Photo.attr("href", mod.Photo)) : ( // src.GHome.attr("href", mod.GHome)
        src.GVideo.attr("href", mod.GVideo), src.GCategory.attr("href", mod.GCategory), src.GPornstar.attr("href", mod.GPornstar), src.GCommunity.attr("href", mod.GCommunity), src.GPhoto.attr("href", mod.GPhoto));
      };

      _general__WEBPACK_IMPORTED_MODULE_0__.config.blurimg ? blurMO.observe(document.body, {
        subtree: true,
        childList: true
      }) : false;
      _general__WEBPACK_IMPORTED_MODULE_0__.config.autoscroll ? window.scrollTo(0, 110) : false;
      _general__WEBPACK_IMPORTED_MODULE_0__.config.comments ? $("#cmtWrapper").removeClass("rm") : $("#cmtWrapper").addClass("rm");
      !_general__WEBPACK_IMPORTED_MODULE_0__.config.sidebar ? phLogo() : false;
      !_general__WEBPACK_IMPORTED_MODULE_0__.config.topbutton ? topBTN() : false;

      if (_general__WEBPACK_IMPORTED_MODULE_0__.config.altplayers !== "none" && /view_video.php/.test(_general__WEBPACK_IMPORTED_MODULE_0__.locate)) {
