...
brws.storage.local.get(storedConfig => {
  ...
  $form = (_document$querySelect = document.querySelector("form")) !== null && _document$querySelect !== void 0 ? _document$querySelect : console.log("[MagicPH] can't find ".concat(target)), config = _objectSpread({
    altplayers: "none",
    autoscroll: true,
    blurimg: false,
    comments: false,
