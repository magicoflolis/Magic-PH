...
const translations = {
 "en": {
  "userjs_inject": "Show Magic PH",
  "userjs_close": "Close Magic PH",
  "userjs_autoinject": "Show the button on page load",
  "userjs_fullscreen": "Open maximized",
  "newTab": "New Tab",
  "newtab_hint": "Type or paste a video URL or ID in the address bar and press Enter.",
  "empty": "No videos found on this page.",
  "search_placeholder": "Filter videos",
  "search_settings": "Settings",
  "copy": "Copy",
  "copy_all": "Copy the URL of every video",
  "close": "Close",
  "download": "Download",
  "download_all": "Download every video",
  "remove": "Remove",
  "remove_all": "Remove every video",
  "open": "Open",
  "min": "Minimize",
  "max": "Maximize",
  "issue": "New issue",
  ...
  "clear_tab_cache": "Delete the videos of a tab when it is closed",
  "limit_downloads": "Download one video at a time",
  "auto_hls": "Build HLS videos automatically",
  "concurrency": "Simultaneous downloads",
  "dtime": "Time before the button fades",
  "hls_load": "Get from HLS stream",
  "free": "Free",
  "prev": "Previous",
  "next": "Next",
  "drm_notice": "DRM protected: there is nothing to play or download.",
  ...
  "play_error": "The browser cannot play this video. Download it instead."
 }
};
/** [source code](https://github.com/magicoflolis/Magic-PH/tree/master/src/sass/_main.scss) */
const main_css = `mujs-root{font-family:var(--mujs-font-family, Arial, Helvetica, sans-serif);text-rendering:optimizeLegibility;word-break:normal;font-size:14px;line-height:1.35;color:var(--mph-text-color, hsl(210, 12%, 97%));text-align:start}mujs-root,mujs-root *{box-sizing:border-box}mujs-root *{scrollbar-color:var(--mph-site-color, hsl(36, 100%, 50%)) hsl(224,14%,15%);scrollbar-width:thin}mujs-root,mujs-main,mujs-toolbar,mujs-header,mujs-body,mujs-list,mujs-post,mujs-tile,mujs-viewer,mujs-config,mujs-section,mujs-url,mujs-empty,mujs-elem,mu-js,tab-content,tab-host{display:block}.hidden{display:none !important}mujs-column,mujs-row,tab-root,.mujs-sty-flex{display:flex}mujs-column,mujs-row{gap:.5em}.mujs-icon{width:1em;height:1em;fill:currentcolor;flex:none;vertical-align:-0.125em}mujs-a,mujs-btn,tab-add,tab-close{cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}mujs-a,mujs-btn{display:inline-flex;align-items:center;justify-content:center;gap:.3em;padding:.3em .7em;border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:6px;background:var(--mph-background-color, hsl(0, 0%, 0%));color:var(--mph-site-color, hsl(36, 100%, 50%));font-weight:500;text-decoration:none;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}mujs-a:hover,mujs-a:focus-visible,mujs-btn:hover,mujs-btn:focus-visible{background:var(--mph-hover-color, hsl(36, 100%, 35%));color:var(--mph-text-color, hsl(210, 12%, 97%));outline:none}mujs-a:focus-visible,mujs-btn:focus-visible{box-shadow:0 0 0 2px var(--mph-site-color, hsl(36, 100%, 50%))}mujs-a[data-busy],mujs-btn[data-busy]{opacity:.6;pointer-events:none}mujs-a[disabled],mujs-btn[disabled]{opacity:.5;pointer-events:none}mujs-mainframe{position:fixed;z-index:2147483647;bottom:var(--mujs-position-bottom, 1rem);right:var(--mujs-position-right, 1rem);top:var(--mujs-position-top, auto);left:var(--mujs-position-left, auto);display:flex;align-items:center;gap:.4em;padding:.55em .9em;border:2px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:1000px;background:var(--mph-background-color, hsl(0, 0%, 0%));color:var(--mph-site-color, hsl(36, 100%, 50%));font-size:16px;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;transition:opacity .25s ease}mujs-mainframe:hover,mujs-mainframe:focus-visible{background:var(--mph-hover-color, hsl(36, 100%, 35%));color:var(--mph-text-color, hsl(210, 12%, 97%));outline:none}mujs-mainframe .mujs-icon{width:1.3em;height:1.3em}count-frame{display:inline-block;min-width:1em;text-align:center;font-weight:700}mujs-toast{display:none;position:fixed;z-index:2147483647;top:1em;left:50%;max-width:min(90vw,40em);padding:.6em 1.1em;transform:translateX(-50%);border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:1000px;background:var(--mph-background-color, hsl(0, 0%, 0%));color:var(--mph-site-color, hsl(36, 100%, 50%));font-weight:600;text-align:center;overflow-wrap:anywhere;pointer-events:none}mujs-toast.show{display:block}mujs-main{position:fixed;z-index:2147483647;right:1rem;bottom:1rem;width:min(780px,100vw - 2rem);height:min(492px,100vh - 2rem);flex-direction:column;border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:16px;background:var(--mph-root-bg, hsla(0, 0%, 6%, 0.97));color:var(--mph-text-color, hsl(210, 12%, 97%));overflow:hidden}mujs-main:not(.hidden){display:flex}mujs-main.expanded{right:0;bottom:0;left:0;width:100%;height:100%;border-radius:0}@media screen and (max-width: 800px){mujs-main{left:0;right:0;bottom:0;width:100%;height:min(72vh,100%);border-radius:16px 16px 0 0;padding-bottom:env(safe-area-inset-bottom, 0px)}mujs-main.expanded{height:100%;border-radius:0}}@media screen and (max-height: 500px){mujs-main{height:100%}}mujs-root[data-side=left] mujs-main:not(.expanded){right:auto;left:1rem}mujs-toolbar{display:flex;justify-content:space-between;gap:.5em;padding:.5em;flex:none}mujs-toolbar .btn-handles{order:999;flex:none}mujs-toolbar tab-root{flex:1;min-width:0;order:0;flex-flow:row nowrap;gap:.5em;text-align:center;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;scrollbar-width:none;-ms-overflow-style:none;padding-bottom:2px}mujs-toolbar tab-root::-webkit-scrollbar{display:none;width:0;height:0}tab-content{display:flex;justify-content:space-between;gap:.5em;padding:.25em .5em;min-width:8em;max-width:min(16em,100% - 2.5em);flex:none;border:1px solid rgba(0,0,0,0);border-radius:4px;cursor:pointer;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}tab-content.active,tab-content:hover{background:hsla(0,0%,100%,.06);border-color:var(--mph-border-color, hsl(36, 100%, 50%))}tab-content tab-host{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}tab-content tab-close{flex:none;opacity:.7}tab-content tab-close:hover{opacity:1;color:var(--mph-site-color, hsl(36, 100%, 50%))}tab-add{position:-webkit-sticky;position:sticky;right:0;flex:none;background:var(--mph-root-bg, hsla(0, 0%, 6%, 0.97));order:999999;padding:0 .4em;font-size:20px;line-height:1.2;border-radius:4px}tab-add:hover{background:hsla(0,0%,100%,.06)}mujs-header{display:flex;flex:none;align-items:center;gap:.5em;padding:.5em;background:var(--mph-header-bg, hsla(0, 0%, 0%, 0.35));border-top:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-bottom:1px solid var(--mph-border-color, hsl(36, 100%, 50%));flex-wrap:wrap}mujs-header mujs-url{flex:1 1 10em;min-width:0}mujs-header .of-actions{flex:none}mujs-column.btn-handles{align-items:center}.btn-handles mujs-btn{padding:.3em .5em}input{font:inherit;color:var(--mph-text-color, hsl(210, 12%, 97%));background:rgba(0,0,0,.35);border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:6px;padding:.3em .6em;outline:none}input:focus{box-shadow:0 0 0 2px var(--mph-site-color, hsl(36, 100%, 50%))}input[type=checkbox]{display:none}.mujs-url-bar{width:100%}mujs-body{flex:1;min-height:0;overflow:auto;padding:.5em}mujs-empty{padding:2em 1em;text-align:center;opacity:.8}.mujs-footer{flex:none;flex-direction:column;max-height:25%;overflow:auto;padding:0 .5em}.mujs-footer .error{display:block;margin:.25em 0;padding:.4em .6em;border-radius:6px;background:rgb(112.2,0,0);white-space:pre-wrap;overflow-wrap:anywhere;cursor:pointer}.mph-feed{display:grid;grid-template-columns:repeat(auto-fit, minmax(min(100%, 21em), 1fr));align-items:start;gap:.75em}.mph-feed.hidden{display:none}mujs-post{display:flex;flex-direction:column;gap:.6em;justify-self:center;width:100%;max-width:34em;padding:.75em;border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:14px;background:hsla(0,0%,100%,.06)}.post-head{align-items:center;gap:.75em}.post-head>mujs-a{flex:none}.avatar{display:flex;flex:none;align-items:center;justify-content:center;width:2.6em;height:2.6em;overflow:hidden;border-radius:50%;background:var(--mph-accent, var(--mph-site-color, hsl(196, 100%, 47%)));color:#fff;font-weight:700}.avatar img{width:100%;height:100%;-o-object-fit:cover;object-fit:cover}.avatar .mujs-icon{width:1.2em;height:1.2em}.post-who{flex:1;min-width:0}.post-name{font-weight:700;overflow-wrap:anywhere}mujs-post[data-variant=video]{max-width:60em}mujs-post[data-variant=video] .post-media[data-count="1"]{grid-template-columns:minmax(0, 24em)}mujs-post[data-variant=video] .post-name{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:2}.post-handle{font-weight:400;opacity:.7}.post-meta{font-size:12px;opacity:.75}.post-meta:empty{display:none}.pill{flex:none;padding:.15em .75em;border-radius:1000px;background:var(--mph-accent, var(--mph-site-color, hsl(196, 100%, 47%)));color:#fff;font-weight:700}.pill.free{background:hsl(140,55%,33%)}.pill.muted{background:hsla(0,0%,100%,.06);color:var(--mph-text-color, hsl(210, 12%, 97%));font-weight:500}.post-text{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:4;white-space:pre-wrap;overflow-wrap:anywhere}.post-media{display:grid;grid-template-columns:repeat(auto-fill, minmax(8.5em, 1fr));gap:4px;overflow:hidden;border-radius:10px}.post-media mujs-tile{aspect-ratio:16/9}.post-media[data-count="1"]{grid-template-columns:1fr}mujs-post[data-variant=post] .post-media mujs-tile{aspect-ratio:1}mujs-post[data-variant=post] .post-media[data-count="1"] mujs-tile{aspect-ratio:16/9}mujs-post[data-variant=post] .post-media[data-count="2"]{grid-template-columns:1fr 1fr}mujs-post[data-variant=post] .post-media[data-count="3"]{grid-template-columns:2fr 1fr;grid-template-rows:1fr 1fr}mujs-post[data-variant=post] .post-media[data-count="3"] mujs-tile:first-child{grid-row:span 2;aspect-ratio:auto}mujs-tile{position:relative;overflow:hidden;background:hsl(0,0%,12%)}mujs-tile[data-command]{cursor:pointer}mujs-tile[data-busy]{opacity:.7;pointer-events:none}mujs-tile>img,mujs-tile>video,mujs-tile>.thumb-none{position:absolute;inset:0;width:100%;height:100%;-o-object-fit:cover;object-fit:cover}mujs-tile>video,mujs-tile>.thumb-none{pointer-events:none}mujs-tile>.thumb-none{display:flex;align-items:center;justify-content:center;opacity:.5}mujs-tile>.thumb-none .mujs-icon{width:2em;height:2em}mujs-tile[data-type=video][data-command]::after{content:"";position:absolute;top:50%;left:50%;width:0;height:0;transform:translate(-35%, -50%);border-style:solid;border-width:.6em 0 .6em 1em;border-color:rgba(0,0,0,0) rgba(0,0,0,0) rgba(0,0,0,0) hsla(0,0%,100%,.9);-webkit-filter:drop-shadow(0 0 4px hsla(0, 0%, 0%, 0.6));filter:drop-shadow(0 0 4px hsla(0, 0%, 0%, 0.6));pointer-events:none}mujs-tile .badge{position:absolute;bottom:.4em;left:.4em;z-index:1;display:flex;align-items:center;gap:.25em;padding:.1em .55em;border-radius:1000px;background:rgba(0,0,0,.7);color:#fff;font-size:12px;font-weight:600}mujs-tile .badge.drm{background:hsl(0,80%,35%)}mujs-tile .badge.top{top:.4em;bottom:auto}mujs-tile .tile-actions{position:absolute;top:.35em;right:.35em;z-index:1;display:flex;gap:.25em;opacity:0;transition:opacity .15s ease}mujs-tile:hover .tile-actions,mujs-tile:focus-within .tile-actions{opacity:1}mujs-tile .tile-btn{padding:.3em;border-color:rgba(0,0,0,0);background:rgba(0,0,0,.7);color:#fff}mujs-viewer{position:fixed;z-index:2147483647;inset:0;display:flex;flex-direction:column;background:rgba(0,0,0,.94);color:#fff}mujs-viewer.hidden{display:none !important}.viewer-bar{flex:none;align-items:center;padding:calc(.5em + env(safe-area-inset-top, 0px)) calc(.75em + env(safe-area-inset-right, 0px)) .5em calc(.75em + env(safe-area-inset-left, 0px))}.viewer-count{flex:none;opacity:.8}.viewer-title{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.viewer-wrap{position:relative;display:flex;flex:1;min-height:0}.viewer-stage{display:flex;flex:1;align-items:center;justify-content:center;min-width:0;padding:.25em}.viewer-stage img,.viewer-stage video{max-width:100%;max-height:100%;-o-object-fit:contain;object-fit:contain}.viewer-stage audio{width:min(90%,32em)}.viewer-msg{max-width:28em;padding:1em;border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:12px;text-align:center}.viewer-nav{position:absolute;top:50%;z-index:1;width:2.4em;height:2.4em;padding:0;transform:translateY(-50%);border-radius:50%;background:rgba(0,0,0,.55);font-size:26px;line-height:1}.viewer-nav.prev{left:.5em}.viewer-nav.next{right:.5em}.viewer-strip{display:flex;flex:none;gap:4px;overflow-x:auto;padding:.5em .5em calc(.5em + env(safe-area-inset-bottom, 0px));scrollbar-width:none;-ms-overflow-style:none}.viewer-strip::-webkit-scrollbar{display:none;width:0;height:0}.viewer-strip.hidden{display:none}.viewer-strip .thumb{flex:none;width:56px;height:56px;border-radius:6px;opacity:.6;color:#fff;text-align:center;line-height:56px}.viewer-strip .thumb:first-child{margin-left:auto}.viewer-strip .thumb:last-child{margin-right:auto}.viewer-strip .thumb.active{opacity:1;outline:2px solid var(--mph-accent, var(--mph-site-color, hsl(196, 100%, 47%)))}.viewer-strip .thumb-label{position:absolute;right:0;bottom:0;left:0;background:rgba(0,0,0,.7);font-size:11px;line-height:1.6}mujs-root[data-mobile] mujs-a,mujs-root[data-mobile] mujs-btn{min-height:40px}mujs-root[data-mobile] input,mujs-root[data-mobile] select{font-size:16px}mujs-root[data-mobile] mujs-tile .tile-actions{opacity:1}mujs-root[data-mobile] .btn-handles mujs-btn{min-width:40px}mujs-root[data-mobile] .viewer-nav{width:2.8em;height:2.8em}select{font:inherit;color:var(--mph-text-color, hsl(210, 12%, 97%));background:rgba(0,0,0,.35);border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:6px;padding:.3em .6em}mujs-config{display:flex;flex-direction:column;gap:.5em}mujs-config.hidden{display:none}mujs-section{display:flex;flex-direction:column;gap:.25em;padding:.5em;border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:8px}mujs-section>label{font-size:16px;font-weight:600;cursor:pointer}mujs-section.collapsed>*:not(:first-child){display:none}.sub-section{display:flex;align-items:center;justify-content:space-between;gap:1em;padding:.2em .25em;overflow-wrap:anywhere}.sub-section input:not([type=checkbox]){width:14em;max-width:50%}mujs-btn.sub-section{align-self:flex-start}.mujs-inlab{position:relative;flex:none;width:38px}.mujs-inlab input[type=checkbox]{display:none}.mujs-inlab input[type=checkbox]:checked+label{background:var(--mph-site-color, hsl(36, 100%, 50%))}.mujs-inlab input[type=checkbox]:checked+label::before{right:0}.mujs-inlab label{display:block;overflow:hidden;height:16px;padding:0;border:1px solid var(--mph-border-color, hsl(36, 100%, 50%));border-radius:20px;cursor:pointer}.mujs-inlab label::before{content:"";display:block;position:absolute;top:0;right:20px;width:20px;height:20px;margin:-2px;border-radius:20px;background:var(--mph-text-color, hsl(210, 12%, 97%))}.mujs-sty-flex{justify-content:space-evenly;flex-wrap:wrap;gap:.5em;padding:.5em 0}.mujs-sty-flex mujs-btn{padding:.4em 1.5em}.about mujs-a{border-color:rgba(0,0,0,0);background:rgba(0,0,0,0);text-decoration:underline}.mujs-invalid{border-color:red !important;box-shadow:0 0 0 2px red}`;
/******************************************************************************/
/**
